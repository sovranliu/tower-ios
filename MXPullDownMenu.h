...
//- (MXPullDownMenu *)initWithArray:(NSArray *)array selectedColor:(UIColor *)color withFrame:(CGRect)rect;
//- (MXPullDownMenu *)initWithArray:(NSArray *)array selectedColor:(UIColor *)color withFrame:(CGRect)rect withTabelFrame:(CGRect)tableRect showArrow:(BOOL)flag;

@property (nonatomic) id<MXPullDownMenuDelegate> delegate;
@property (nonatomic,assign)int    tableViewRowNum;
